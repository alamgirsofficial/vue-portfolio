        ...
        <div class="w-full px-5 sm:px-8 md:px-12 lg:px-8 max-w-5xl  mx-auto relative z-10">
               ...
               <!-- Left Side Content -->
                ...
                data-aos="fade-right">
                    <h1 class="text-white font-bold text-4xl md:text-5xl lg:text-6xl leading-tight">
                        Hi, I'm 
                        <span class="text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-cyan-400">Alamgir</span>
                    </h1>
                ...
                data-aos-delay="300">
                    Lorem ipsum dolor sit amet, consectetur
                     adipisicing elit. Natus possimus nostrum 
                     hic corporis deserunt ab odit tenetur
                </p>

            <div class="flex items-center gap-4 pt-8 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0"
            data-aos="fade-up"
            data-aos-delay="300">
            <button class="px-8 md:px-10 py-4 rounded-xl relative group w-full sm:w-max flex justify-center overflow-hidden bg-linear-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 transition-all duration-300"> 
            ...
            <button class=" border-2 border-blue-400 px-8 md:px-10 py-4 rounded-xl relative group w-full sm:w-max flex justify-center hover:bg-blue-400/10 transition-all duration-300">
                <div class="flex items-center justify-center relative">
                    <ArrowDownIcon class="w-5 h-5 text-blue-400 group-hover:translate-y-1 transition-transform">
                        </ArrowDownIcon>
            ...
            <!-- Image  -->
             <div class="lg:h-full flex justify-center lg:justify-end ">
                <div class="relative w-full max-w-md lg:max-w-md">
                    <div class="relative z-10 bg-linear-to-r from-blue-600 to-cyan-600 shadow-2xl rounded-[50%_40%_30%_60%_/60%_30%_70%_30%] p-4 backdrop-blur-sm border border-blue-500/30 -translate-y-6" 
                    data-aos="zoom-in" data-aos-delay="500">

                        <div class="rounded-xl overflow-hidden" >
                            <img :src="heroImage" alt=" My Profile" 
                            loading="lazy" 
                            class="w-[500px] h-[500px] object-contain -translate-y-8">    
                        </div>
                    </div>
                    <div class="absolute -top-2 -right-4 w-10 h-10 bg-blue-400 rounded-full blur-sm opacity-50 animate-pulse
                    ">
